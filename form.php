...
<body>
    ...
    if (array_key_exists('phone', $_POST)) {
        ...
        $mail->Username = '';
        $mail->Password = '';
        $mail->setFrom('', 'Carema.pl - Formularz zgłoszeniowy');
...
Znajomość języka niemieckiego: {$_POST['language_level']}
Doświadczenie w opiece: {$_POST['experienceRange']}
